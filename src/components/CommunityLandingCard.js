...
function CommunityLandingCard() {
    ...
    return (
        <Center>
            <LandingCard title="Latest pick from our users!" description={currentMessage} image="lostInTheJungle.jpg" moreinfo="" footerinfo="Powered by Firebase Realtime Database" />
        </Center>
    )
}
